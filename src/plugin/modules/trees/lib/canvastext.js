...
//
/*
 * Actually see: http://jim.studt.net/canvastext/
 * This file was modified from the original only in that it was:
 * - wrapped in an AMD define
 * - minor reformatting
 * - change some == to ===
 * - remove duplicate definition of comma (see below);
 */
define([], function() {
    'use strict';
